"""
Stage 2: Train U-Net with BigEarthNet for Semantic Segmentation

This script trains a U-Net model with pre-trained encoder from Stage 1
...
def main(args):
    ...
    # Setup logging
    log_file = LOGS_DIR / 'stage2_training.log'
    logger = setup_logger('stage2', log_file, 'INFO')
    
    logger.info("="*70)
    logger.info("Stage 2: U-Net Training with BigEarthNet")
    logger.info("="*70)
    ...
    # Create model
    logger.info(f"\nCreating U-Net model with encoder: {STAGE2_CONFIG['encoder_name']}")
    ...
    stage2_checkpoint_dir = CHECKPOINTS_DIR / 'stage2'
    ...
    logger.info("\n" + "="*70)
    logger.info("Phase 2.2: Fine-tuning entire U-Net")
    logger.info("="*70)
    ...
    cm_path = VISUALIZATIONS_DIR / 'stage2_confusion_matrix.png'
    plot_confusion_matrix(cm, CLASS_NAMES, cm_path)
    
    # Training curves
    curves_path = VISUALIZATIONS_DIR / 'stage2_training_curves.png'
    ...
    with torch.no_grad():
        ...
        # Visualize
        vis_path = VISUALIZATIONS_DIR / 'stage2_predictions.png'
        visualize_segmentation(
            images=images,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Stage 2: Train U-Net with BigEarthNet')
